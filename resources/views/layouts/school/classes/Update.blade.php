        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <!--begin::Form-->
                        <form method="post" action="{{route('classes.update',$class->id)}}" class="kt-form kt-form--label-right">
                            @method('PUT')
                            @csrf
                            <div class="kt-portlet__body">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="scolar_designation" class="form-control" value="{{$class->scolar_designation}}">
                                        <span class="form-text text-muted">La désignation scolaire .ex (2éme1 ...)</span>
                                    </div>
                                    <div class="col-lg-3">
                                        <label>Le niveau scolaire :</label>
                                        <select name="level_id" class="form-control">
                                            <option value="{{$class->level->id}}">{{$class->level->name .' '. strtoupper($class->level->cycle)}}</option>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="physic_designation" class="form-control" value="{{$class->physic_designation}}">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="student_number" class="form-control" value="{{$class->student_number}}">
                                        <span class="form-text text-muted">Le nombre d'etudiants</span>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="">Capacité totale:</label>
                                        <input type="text" name="places_number" class="form-control" value="{{$class->places_number}}">
